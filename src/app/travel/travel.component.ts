  ...
  travelEvents(randomNumber) {
    switch(randomNumber) {
      case 1:
        ...
        this.playerService.getPlayer().output.unshift("<strong>Normally the landscape is full of rough terrain, and obstacles that even a millatary grade transport can't just barrel through. But today there was nothing to slow you down, and the pedal was put to the metal. <br><br>You gain 1 day.</strong><br>")
        break;
      case 2:
        this.playerService.increaseDaysRemaining(2);
        this.playerService.getPlayer().output.unshift("<strong>Along the way you encounter a traveler familiar with the area, you mention your current route, and the traveler points out a shorter route! Netting you an extra couple of days. <br><br>You gain 2 days</strong><br>")
        break;
      case 3:
        this.playerService.increaseDaysRemaining(3);
        this.playerService.getPlayer().output.unshift("<strong>While traveling, the transport picks up stray radio signal's from the 'People's Militia' was establishing defensive line to the south. Looking southwards you can see the signs of battle of in the distance. <br><br>You gain 3 days</strong><br>")
        break;
      case 4:
        this.playerService.decreaseDaysRemaining(1);
        this.playerService.getPlayer().output.unshift("<strong>In life one will encounter many obstacles and challenges to overcome. During travel you encountered many of these obstacles, and lost a day. <br><br>You lose 1 day</strong><br>")
        break;
      case 5:
        this.playerService.decreaseDaysRemaining(2);
        this.playerService.getPlayer().output.unshift("<strong>A large herd of lumbering horned-Riat. Giant rodent-like creatures, known for blocking roads, and paths for potentially days. Also known for goring anyone that gets too close to them. Not wanting to disturb giant rodents, you wait for them to move. two days later they finally moved... <br><br>You lose 2 days.</strong><br>");
        break;
      case 6:
      ...
      case 8:
        ...
        this.playerService.getPlayer().output.unshift("<strong>You were traveling at a good speed when the transport hits something hit something hard. Quickly you stop and get out to check for any damage to the transport. Moving towards the back of the transport you catch the familiar glint of crystals. It would appear you had run over someone's secret stash. <br><br>You gain 20 crystals");
        break;
      case 9:
        this.playerService.increaseCrystals(30);
        this.playerService.getPlayer().output.unshift("<strong>As you traveled through the waste, the silhouettes of some run down buildings appear in your direction. Carefully your transport approaches the buildings, ready to speed off the moment something went wrong. Caution was soon replaced with joy. The building the remains of an old crystal refinery. Better yet, there was still crystals to take! <br><br>You gain 30 crystals.</strong><br>");
      break;
      case 10:
        this.playerService.decreaseCrystals(10);
        this.playerService.getPlayer().output.unshift("<strong>After stoping for the day, you step out of the transport for some fresh air. With a deep inhale, there is the unmistakable smell of charred critter. After a quick look at the transport, you find a poor creature that had managed to get stuck in the engine, making the engine less efficient. Everything runs on crystals, not critters! <br><br>You lose 10 crystals.</strong><br>");
        break;
      case 11:
      ...
      case 12:
        ...
        this.playerService.getPlayer().output.unshift("<strong>You had the misfortune of running into a enterprising group of bandits who have set up a blockade around the only route forward. Know it made no sense to fight them, you paid the toll. Almost as bad as the price of a small cup of Old-World Coffee. <br><br>You lose 30 crystals</strong><br>");
        break;
      case 13:
      ...
      case 16:
        ...
        this.playerService.increaseCrystals(10);
        this.playerService.getPlayer().output.unshift("<strong>While traveling you came across a handfull of synthesized crystals are not only able to be used as full. They are edible! <br><br>You gain 10 HP and 10 Crystals</strong><br>");
        break;
      case 17:
        this.playerService.decreaseHp(10);
        this.playerService.decreaseCrystals(10);
